...
## 🎬 Slide 4: The Product (What Works Today)
...
**Get them using the free tier** → They build something they love → They need to collaborate/deploy → They upgrade
...
```
Manifest JSON → Schema Validation → Template Generation → 
Prettier Formatting → File Writing → HMR Update
```
